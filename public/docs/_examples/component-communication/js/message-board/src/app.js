...
var MessageBus = ng
  ...
  .Class({
    constructor: function() {
      this.messageReceived = new ng.EventEmitter();
...
selector: 'message-board',
  ...
  .Class({
    constructor: [MessageBus, function(messageBus) {
      var component = this;
      this.messages = [];
      this.messageBus = messageBus;
      this.messageBus.messageReceived.subscribe(
        function (msg) {
          component.messages.push(msg);
        }
      );
    }]
  });
