...
var JobBoardFacade = ng
  .Injectable()
  .Class({
    constructor: [JobService, function(jobService) {
      var jobSrv = jobService; 
      
      this.post = function(jobRequest) {
        jobSrv.post(jobRequest);
      }
      ...
      this.getJobRequest = function() {
        return jobSrv.getJobRequest();
      }
      
      this.getRespondingHeroes = function() {
        return jobSrv.getRespondingHeroes();
      }
      
      this.getAssignedTo = function() {
        return jobSrv.getAssignedTo();
      }
    }]
  });
  
var InvitedHeroFacade = ng
  .Injectable()
  .Class({
    constructor: [JobService, function(jobService) {
      var jobSrv = jobService;
      ...
      this.getJobPostEvent = function() {
        return jobSrv.jobPostEvent;
      }
      
      this.getJobAssignedEvent = function() {
        return jobSrv.jobAssignedEvent;
      }
    }]
  });
...
var InvitedHero = ng
  ...
  .Class({
    constructor: [InvitedHeroFacade, function (jobService) {
      var component = this;
      ...
      this.jobService.getJobPostEvent().subscribe(
        function(request){
          component.request = request;
          component.undertaken = false;
        });
      this.jobService.getJobAssignedEvent().subscribe(
          function(winner){
...
var HeroJobBoard = ng
  .Component({
    ...
    directives: [ng.NgFor,
      InvitedHero],
    providers: [
      ng.provide(JobService, {useValue: jobService}),
      JobBoardFacade,
      InvitedHeroFacade
    ]
  })
  .Class({
    constructor: [JobBoardFacade, function (jobService) {
      this.jobService = jobService;
