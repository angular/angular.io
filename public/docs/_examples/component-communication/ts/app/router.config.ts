...
import {HeroJobBoard as BoardWithContent} from './take-job-contentchildren/hero-job-board';
...
export const ROUTES:RouteDefinition[] = [
  ...
  {path: '/take-job-contentchildren', name: 'Using @ContentChildren',      component: BoardWithContent}
];
