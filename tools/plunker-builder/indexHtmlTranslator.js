...
var _rxData = [
  ...
  },
  {
    ...
    to: 'https://code.angularjs.org/2.0.0-beta.2/angular2.dev.js'
  },
  {
    pattern: 'script',
    from: 'node_modules/angular2/bundles/angular2-all.umd.js',
    to: 'https://code.angularjs.org/2.0.0-beta.2/angular2-all.umd.dev.js'
  },  
  {
    pattern: 'script',
    from: 'node_modules/angular2/bundles/angular2-polyfills.js',
    to: 'https://code.angularjs.org/2.0.0-beta.2/angular2-polyfills.js'
  },
  {
    pattern: 'script',
    from: 'node_modules/rxjs/bundles/Rx.js',
    to: 'https://code.angularjs.org/2.0.0-beta.2/Rx.js'
  },  
  {
    pattern: 'script',
    from: 'node_modules/rxjs/bundles/Rx.umd.js',
    to: 'https://code.angularjs.org/2.0.0-beta.2/Rx.umd.js'
  },  
  {
    pattern: 'script',
    from: 'node_modules/angular2/bundles/router.dev.js',
    to: 'https://code.angularjs.org/2.0.0-beta.2/router.dev.js'
  },
  {
    pattern: 'script',
    from: 'node_modules/angular2/bundles/http.dev.js',
    to: 'https://code.angularjs.org/2.0.0-beta.2/http.dev.js'
  },
  {
    pattern: 'script',
    from: 'node_modules/angular2/bundles/testing.dev.js',
    to: 'https://code.angularjs.org/2.0.0-beta.2/testing.dev.js'
  },
  {
    pattern: 'script',
